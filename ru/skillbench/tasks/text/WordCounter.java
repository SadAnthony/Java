...
public interface WordCounter
{
     ...
     * Слова с одинаковым количеством вхождений упорядочиваются в алфавитном порядке
     ...
     * @return Содержимое <code>map</code> в виде списка, упорядоченного в соответствии
     * с <code>comparator</code>
     */
    <K extends Comparable<K>, V extends Comparable<V>> List<Map.Entry<K,V>>
     ...
     * <br/>
     * ПРИМЕЧАНИЕ: Этот метод работает только со своими параметрами,
     * но не с полями объекта {@link WordCounter}.
